...
`v2.12.0` 已开发完成，等产品负责人验收：首屏拆成「公共资产」和「项目」两个视图，
修掉 5 个抽屉的浮层定位 bug，新项目可以从公共资产库挑资产，规则包能下载示例和自行打包，
技术档案能从 `package.json` 出草稿。变更记录见 [CHANGELOG](CHANGELOG.md)，
验收清单见 [v2.12.0](docs/acceptance/v2.12.0.md)，
