...
`v2.10.0` 已发布，2.0 这一条功能线全部完成；`v2.11.0` 是统一加固与验收版本，
不新增功能，只验迁移、备份恢复、回滚和安全边界，见
[v2.11.0 验收清单](docs/acceptance/v2.11.0.md)（早期 MVP 加固记录在
[v2.1.3](docs/acceptance/v2.1.3.md)）。
